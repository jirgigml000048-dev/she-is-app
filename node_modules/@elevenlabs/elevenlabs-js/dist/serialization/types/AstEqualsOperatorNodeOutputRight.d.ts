...
export declare namespace AstEqualsOperatorNodeOutputRight {
    type Raw = AstEqualsOperatorNodeOutputRight.AddOperator | AstEqualsOperatorNodeOutputRight.AndOperator | AstEqualsOperatorNodeOutputRight.BooleanLiteral | AstEqualsOperatorNodeOutputRight.ConditionalOperator | AstEqualsOperatorNodeOutputRight.DivOperator | AstEqualsOperatorNodeOutputRight.DynamicVariable | AstEqualsOperatorNodeOutputRight.EqOperator | AstEqualsOperatorNodeOutputRight.GtOperator | AstEqualsOperatorNodeOutputRight.GteOperator | AstEqualsOperatorNodeOutputRight.Llm | AstEqualsOperatorNodeOutputRight.LtOperator | AstEqualsOperatorNodeOutputRight.LteOperator | AstEqualsOperatorNodeOutputRight.MulOperator | AstEqualsOperatorNodeOutputRight.NeqOperator | AstEqualsOperatorNodeOutputRight.NumberLiteral | AstEqualsOperatorNodeOutputRight.OrOperator | AstEqualsOperatorNodeOutputRight.StringLiteral | AstEqualsOperatorNodeOutputRight.SubOperator;
