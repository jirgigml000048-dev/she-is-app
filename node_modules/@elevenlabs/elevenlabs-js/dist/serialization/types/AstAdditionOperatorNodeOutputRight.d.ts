...
export declare const AstAdditionOperatorNodeOutputRight: core.serialization.Schema<serializers.AstAdditionOperatorNodeOutputRight.Raw, ElevenLabs.AstAdditionOperatorNodeOutputRight>;
export declare namespace AstAdditionOperatorNodeOutputRight {
    type Raw = AstAdditionOperatorNodeOutputRight.AddOperator | AstAdditionOperatorNodeOutputRight.AndOperator | AstAdditionOperatorNodeOutputRight.BooleanLiteral | AstAdditionOperatorNodeOutputRight.ConditionalOperator | AstAdditionOperatorNodeOutputRight.DivOperator | AstAdditionOperatorNodeOutputRight.DynamicVariable | AstAdditionOperatorNodeOutputRight.EqOperator | AstAdditionOperatorNodeOutputRight.GtOperator | AstAdditionOperatorNodeOutputRight.GteOperator | AstAdditionOperatorNodeOutputRight.Llm | AstAdditionOperatorNodeOutputRight.LtOperator | AstAdditionOperatorNodeOutputRight.LteOperator | AstAdditionOperatorNodeOutputRight.MulOperator | AstAdditionOperatorNodeOutputRight.NeqOperator | AstAdditionOperatorNodeOutputRight.NumberLiteral | AstAdditionOperatorNodeOutputRight.OrOperator | AstAdditionOperatorNodeOutputRight.StringLiteral | AstAdditionOperatorNodeOutputRight.SubOperator;
