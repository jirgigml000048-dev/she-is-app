...
export declare const AstMultiplicationOperatorNodeOutputLeft: core.serialization.Schema<serializers.AstMultiplicationOperatorNodeOutputLeft.Raw, ElevenLabs.AstMultiplicationOperatorNodeOutputLeft>;
export declare namespace AstMultiplicationOperatorNodeOutputLeft {
    type Raw = AstMultiplicationOperatorNodeOutputLeft.AddOperator | AstMultiplicationOperatorNodeOutputLeft.AndOperator | AstMultiplicationOperatorNodeOutputLeft.BooleanLiteral | AstMultiplicationOperatorNodeOutputLeft.ConditionalOperator | AstMultiplicationOperatorNodeOutputLeft.DivOperator | AstMultiplicationOperatorNodeOutputLeft.DynamicVariable | AstMultiplicationOperatorNodeOutputLeft.EqOperator | AstMultiplicationOperatorNodeOutputLeft.GtOperator | AstMultiplicationOperatorNodeOutputLeft.GteOperator | AstMultiplicationOperatorNodeOutputLeft.Llm | AstMultiplicationOperatorNodeOutputLeft.LtOperator | AstMultiplicationOperatorNodeOutputLeft.LteOperator | AstMultiplicationOperatorNodeOutputLeft.MulOperator | AstMultiplicationOperatorNodeOutputLeft.NeqOperator | AstMultiplicationOperatorNodeOutputLeft.NumberLiteral | AstMultiplicationOperatorNodeOutputLeft.OrOperator | AstMultiplicationOperatorNodeOutputLeft.StringLiteral | AstMultiplicationOperatorNodeOutputLeft.SubOperator;
