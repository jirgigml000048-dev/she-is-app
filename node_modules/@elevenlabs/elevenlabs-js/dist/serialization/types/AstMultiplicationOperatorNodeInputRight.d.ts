...
export declare const AstMultiplicationOperatorNodeInputRight: core.serialization.Schema<serializers.AstMultiplicationOperatorNodeInputRight.Raw, ElevenLabs.AstMultiplicationOperatorNodeInputRight>;
export declare namespace AstMultiplicationOperatorNodeInputRight {
    type Raw = AstMultiplicationOperatorNodeInputRight.AddOperator | AstMultiplicationOperatorNodeInputRight.AndOperator | AstMultiplicationOperatorNodeInputRight.BooleanLiteral | AstMultiplicationOperatorNodeInputRight.ConditionalOperator | AstMultiplicationOperatorNodeInputRight.DivOperator | AstMultiplicationOperatorNodeInputRight.DynamicVariable | AstMultiplicationOperatorNodeInputRight.EqOperator | AstMultiplicationOperatorNodeInputRight.GtOperator | AstMultiplicationOperatorNodeInputRight.GteOperator | AstMultiplicationOperatorNodeInputRight.Llm | AstMultiplicationOperatorNodeInputRight.LtOperator | AstMultiplicationOperatorNodeInputRight.LteOperator | AstMultiplicationOperatorNodeInputRight.MulOperator | AstMultiplicationOperatorNodeInputRight.NeqOperator | AstMultiplicationOperatorNodeInputRight.NumberLiteral | AstMultiplicationOperatorNodeInputRight.OrOperator | AstMultiplicationOperatorNodeInputRight.StringLiteral | AstMultiplicationOperatorNodeInputRight.SubOperator;
