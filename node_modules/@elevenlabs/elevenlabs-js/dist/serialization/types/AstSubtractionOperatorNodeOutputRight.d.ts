...
export declare const AstSubtractionOperatorNodeOutputRight: core.serialization.Schema<serializers.AstSubtractionOperatorNodeOutputRight.Raw, ElevenLabs.AstSubtractionOperatorNodeOutputRight>;
export declare namespace AstSubtractionOperatorNodeOutputRight {
    type Raw = AstSubtractionOperatorNodeOutputRight.AddOperator | AstSubtractionOperatorNodeOutputRight.AndOperator | AstSubtractionOperatorNodeOutputRight.BooleanLiteral | AstSubtractionOperatorNodeOutputRight.ConditionalOperator | AstSubtractionOperatorNodeOutputRight.DivOperator | AstSubtractionOperatorNodeOutputRight.DynamicVariable | AstSubtractionOperatorNodeOutputRight.EqOperator | AstSubtractionOperatorNodeOutputRight.GtOperator | AstSubtractionOperatorNodeOutputRight.GteOperator | AstSubtractionOperatorNodeOutputRight.Llm | AstSubtractionOperatorNodeOutputRight.LtOperator | AstSubtractionOperatorNodeOutputRight.LteOperator | AstSubtractionOperatorNodeOutputRight.MulOperator | AstSubtractionOperatorNodeOutputRight.NeqOperator | AstSubtractionOperatorNodeOutputRight.NumberLiteral | AstSubtractionOperatorNodeOutputRight.OrOperator | AstSubtractionOperatorNodeOutputRight.StringLiteral | AstSubtractionOperatorNodeOutputRight.SubOperator;
