...
export declare const AstMultiplicationOperatorNodeOutputRight: core.serialization.Schema<serializers.AstMultiplicationOperatorNodeOutputRight.Raw, ElevenLabs.AstMultiplicationOperatorNodeOutputRight>;
export declare namespace AstMultiplicationOperatorNodeOutputRight {
    type Raw = AstMultiplicationOperatorNodeOutputRight.AddOperator | AstMultiplicationOperatorNodeOutputRight.AndOperator | AstMultiplicationOperatorNodeOutputRight.BooleanLiteral | AstMultiplicationOperatorNodeOutputRight.ConditionalOperator | AstMultiplicationOperatorNodeOutputRight.DivOperator | AstMultiplicationOperatorNodeOutputRight.DynamicVariable | AstMultiplicationOperatorNodeOutputRight.EqOperator | AstMultiplicationOperatorNodeOutputRight.GtOperator | AstMultiplicationOperatorNodeOutputRight.GteOperator | AstMultiplicationOperatorNodeOutputRight.Llm | AstMultiplicationOperatorNodeOutputRight.LtOperator | AstMultiplicationOperatorNodeOutputRight.LteOperator | AstMultiplicationOperatorNodeOutputRight.MulOperator | AstMultiplicationOperatorNodeOutputRight.NeqOperator | AstMultiplicationOperatorNodeOutputRight.NumberLiteral | AstMultiplicationOperatorNodeOutputRight.OrOperator | AstMultiplicationOperatorNodeOutputRight.StringLiteral | AstMultiplicationOperatorNodeOutputRight.SubOperator;
