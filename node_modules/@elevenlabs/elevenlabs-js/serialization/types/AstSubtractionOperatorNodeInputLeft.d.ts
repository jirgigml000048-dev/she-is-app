...
export declare const AstSubtractionOperatorNodeInputLeft: core.serialization.Schema<serializers.AstSubtractionOperatorNodeInputLeft.Raw, ElevenLabs.AstSubtractionOperatorNodeInputLeft>;
export declare namespace AstSubtractionOperatorNodeInputLeft {
    type Raw = AstSubtractionOperatorNodeInputLeft.AddOperator | AstSubtractionOperatorNodeInputLeft.AndOperator | AstSubtractionOperatorNodeInputLeft.BooleanLiteral | AstSubtractionOperatorNodeInputLeft.ConditionalOperator | AstSubtractionOperatorNodeInputLeft.DivOperator | AstSubtractionOperatorNodeInputLeft.DynamicVariable | AstSubtractionOperatorNodeInputLeft.EqOperator | AstSubtractionOperatorNodeInputLeft.GtOperator | AstSubtractionOperatorNodeInputLeft.GteOperator | AstSubtractionOperatorNodeInputLeft.Llm | AstSubtractionOperatorNodeInputLeft.LtOperator | AstSubtractionOperatorNodeInputLeft.LteOperator | AstSubtractionOperatorNodeInputLeft.MulOperator | AstSubtractionOperatorNodeInputLeft.NeqOperator | AstSubtractionOperatorNodeInputLeft.NumberLiteral | AstSubtractionOperatorNodeInputLeft.OrOperator | AstSubtractionOperatorNodeInputLeft.StringLiteral | AstSubtractionOperatorNodeInputLeft.SubOperator;
