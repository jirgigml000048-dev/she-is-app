...
export declare const AstAdditionOperatorNodeInputLeft: core.serialization.Schema<serializers.AstAdditionOperatorNodeInputLeft.Raw, ElevenLabs.AstAdditionOperatorNodeInputLeft>;
export declare namespace AstAdditionOperatorNodeInputLeft {
    type Raw = AstAdditionOperatorNodeInputLeft.AddOperator | AstAdditionOperatorNodeInputLeft.AndOperator | AstAdditionOperatorNodeInputLeft.BooleanLiteral | AstAdditionOperatorNodeInputLeft.ConditionalOperator | AstAdditionOperatorNodeInputLeft.DivOperator | AstAdditionOperatorNodeInputLeft.DynamicVariable | AstAdditionOperatorNodeInputLeft.EqOperator | AstAdditionOperatorNodeInputLeft.GtOperator | AstAdditionOperatorNodeInputLeft.GteOperator | AstAdditionOperatorNodeInputLeft.Llm | AstAdditionOperatorNodeInputLeft.LtOperator | AstAdditionOperatorNodeInputLeft.LteOperator | AstAdditionOperatorNodeInputLeft.MulOperator | AstAdditionOperatorNodeInputLeft.NeqOperator | AstAdditionOperatorNodeInputLeft.NumberLiteral | AstAdditionOperatorNodeInputLeft.OrOperator | AstAdditionOperatorNodeInputLeft.StringLiteral | AstAdditionOperatorNodeInputLeft.SubOperator;
