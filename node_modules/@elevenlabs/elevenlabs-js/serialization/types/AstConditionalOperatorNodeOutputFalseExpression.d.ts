...
export declare const AstConditionalOperatorNodeOutputFalseExpression: core.serialization.Schema<serializers.AstConditionalOperatorNodeOutputFalseExpression.Raw, ElevenLabs.AstConditionalOperatorNodeOutputFalseExpression>;
export declare namespace AstConditionalOperatorNodeOutputFalseExpression {
    type Raw = AstConditionalOperatorNodeOutputFalseExpression.AddOperator | AstConditionalOperatorNodeOutputFalseExpression.AndOperator | AstConditionalOperatorNodeOutputFalseExpression.BooleanLiteral | AstConditionalOperatorNodeOutputFalseExpression.ConditionalOperator | AstConditionalOperatorNodeOutputFalseExpression.DivOperator | AstConditionalOperatorNodeOutputFalseExpression.DynamicVariable | AstConditionalOperatorNodeOutputFalseExpression.EqOperator | AstConditionalOperatorNodeOutputFalseExpression.GtOperator | AstConditionalOperatorNodeOutputFalseExpression.GteOperator | AstConditionalOperatorNodeOutputFalseExpression.Llm | AstConditionalOperatorNodeOutputFalseExpression.LtOperator | AstConditionalOperatorNodeOutputFalseExpression.LteOperator | AstConditionalOperatorNodeOutputFalseExpression.MulOperator | AstConditionalOperatorNodeOutputFalseExpression.NeqOperator | AstConditionalOperatorNodeOutputFalseExpression.NumberLiteral | AstConditionalOperatorNodeOutputFalseExpression.OrOperator | AstConditionalOperatorNodeOutputFalseExpression.StringLiteral | AstConditionalOperatorNodeOutputFalseExpression.SubOperator;
