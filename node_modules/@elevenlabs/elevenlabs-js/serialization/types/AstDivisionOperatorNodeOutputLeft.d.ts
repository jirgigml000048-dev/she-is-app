...
export declare const AstDivisionOperatorNodeOutputLeft: core.serialization.Schema<serializers.AstDivisionOperatorNodeOutputLeft.Raw, ElevenLabs.AstDivisionOperatorNodeOutputLeft>;
export declare namespace AstDivisionOperatorNodeOutputLeft {
    type Raw = AstDivisionOperatorNodeOutputLeft.AddOperator | AstDivisionOperatorNodeOutputLeft.AndOperator | AstDivisionOperatorNodeOutputLeft.BooleanLiteral | AstDivisionOperatorNodeOutputLeft.ConditionalOperator | AstDivisionOperatorNodeOutputLeft.DivOperator | AstDivisionOperatorNodeOutputLeft.DynamicVariable | AstDivisionOperatorNodeOutputLeft.EqOperator | AstDivisionOperatorNodeOutputLeft.GtOperator | AstDivisionOperatorNodeOutputLeft.GteOperator | AstDivisionOperatorNodeOutputLeft.Llm | AstDivisionOperatorNodeOutputLeft.LtOperator | AstDivisionOperatorNodeOutputLeft.LteOperator | AstDivisionOperatorNodeOutputLeft.MulOperator | AstDivisionOperatorNodeOutputLeft.NeqOperator | AstDivisionOperatorNodeOutputLeft.NumberLiteral | AstDivisionOperatorNodeOutputLeft.OrOperator | AstDivisionOperatorNodeOutputLeft.StringLiteral | AstDivisionOperatorNodeOutputLeft.SubOperator;
