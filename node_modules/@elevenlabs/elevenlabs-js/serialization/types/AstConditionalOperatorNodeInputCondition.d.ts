...
export declare const AstConditionalOperatorNodeInputCondition: core.serialization.Schema<serializers.AstConditionalOperatorNodeInputCondition.Raw, ElevenLabs.AstConditionalOperatorNodeInputCondition>;
export declare namespace AstConditionalOperatorNodeInputCondition {
    type Raw = AstConditionalOperatorNodeInputCondition.AddOperator | AstConditionalOperatorNodeInputCondition.AndOperator | AstConditionalOperatorNodeInputCondition.BooleanLiteral | AstConditionalOperatorNodeInputCondition.ConditionalOperator | AstConditionalOperatorNodeInputCondition.DivOperator | AstConditionalOperatorNodeInputCondition.DynamicVariable | AstConditionalOperatorNodeInputCondition.EqOperator | AstConditionalOperatorNodeInputCondition.GtOperator | AstConditionalOperatorNodeInputCondition.GteOperator | AstConditionalOperatorNodeInputCondition.Llm | AstConditionalOperatorNodeInputCondition.LtOperator | AstConditionalOperatorNodeInputCondition.LteOperator | AstConditionalOperatorNodeInputCondition.MulOperator | AstConditionalOperatorNodeInputCondition.NeqOperator | AstConditionalOperatorNodeInputCondition.NumberLiteral | AstConditionalOperatorNodeInputCondition.OrOperator | AstConditionalOperatorNodeInputCondition.StringLiteral | AstConditionalOperatorNodeInputCondition.SubOperator;
