...
export declare const AstDivisionOperatorNodeOutputRight: core.serialization.Schema<serializers.AstDivisionOperatorNodeOutputRight.Raw, ElevenLabs.AstDivisionOperatorNodeOutputRight>;
export declare namespace AstDivisionOperatorNodeOutputRight {
    type Raw = AstDivisionOperatorNodeOutputRight.AddOperator | AstDivisionOperatorNodeOutputRight.AndOperator | AstDivisionOperatorNodeOutputRight.BooleanLiteral | AstDivisionOperatorNodeOutputRight.ConditionalOperator | AstDivisionOperatorNodeOutputRight.DivOperator | AstDivisionOperatorNodeOutputRight.DynamicVariable | AstDivisionOperatorNodeOutputRight.EqOperator | AstDivisionOperatorNodeOutputRight.GtOperator | AstDivisionOperatorNodeOutputRight.GteOperator | AstDivisionOperatorNodeOutputRight.Llm | AstDivisionOperatorNodeOutputRight.LtOperator | AstDivisionOperatorNodeOutputRight.LteOperator | AstDivisionOperatorNodeOutputRight.MulOperator | AstDivisionOperatorNodeOutputRight.NeqOperator | AstDivisionOperatorNodeOutputRight.NumberLiteral | AstDivisionOperatorNodeOutputRight.OrOperator | AstDivisionOperatorNodeOutputRight.StringLiteral | AstDivisionOperatorNodeOutputRight.SubOperator;
