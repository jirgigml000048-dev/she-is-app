...
export const fmpsTest = {
  ...
  results: {
    high_cm_da: { label: '你太怕做错了', emoji: '🎯', tagline: '', desc: '你对犯错有很强的恐惧，同时在开始一件事之前会反复犹豫。不是不想做，是太怕做错。这种组合很常见，也很耗力气。' },
    high_ps_low_cm: { label: '你对自己有很高的要求，但不会被它压垮', emoji: '🎯', tagline: '', desc: '你给自己设定的标准比多数人高，但你不会因为没达到就觉得自己失败。这是适应性完美主义——推动你前进，而不是拖住你。' },
    high_pe: { label: '你内化了很多来自父母的标准', emoji: '🎯', tagline: '', desc: '你感受到父母对你有很高的期待，这些期待已经成了你评价自己的一把尺子。有时候你可能不太清楚，哪些标准是你真正想要的。' },
    high_da_low_cm: { label: '开始对你来说是最难的那一步', emoji: '🎯', tagline: '', desc: '你不太担心犯错本身，但「做完了是不是真的对」这个问题会困住你。有时候为了做好一件事，你需要比别人更长的准备时间。' },
    high_or: { label: '你喜欢秩序，但不焦虑', emoji: '🎯', tagline: '', desc: '整洁和条理对你很重要，但这更像是一种偏好，而不是强迫。你的完美主义是轻量的，甚至有点让人羡慕。' },
    balanced: { label: '你在「够好」和「更好」之间找到了某种平衡', emoji: '🎯', tagline: '', desc: '你的完美主义各维度都不特别突出，说明你对「做好」这件事的态度比较灵活。不同情境下你会调整自己的标准，这是一种实用主义。' },
  },
}
...
export const boundaryTest = {
  ...
  results: {
    '情感型边界缺失': { label: '你更容易被"别让人失望"牵着走', emoji: '🌿', tagline: '', desc: '你很在意关系里的温度，也很能共情别人，所以拒绝对你来说常常带着愧疚感。你不是不会保护自己，只是每次轮到自己时，总想再让一步。' },
    '社交型边界缺失': { label: '你更容易在群体氛围里退让', emoji: '🌿', tagline: '', desc: '一对一时你未必没有想法，但只要放进群体情境里，你会更在意场面是否和气、自己是否显得扫兴。很多时候，不是你没有边界，而是你太容易先照顾气氛。' },
    '自我型边界缺失': { label: '你有时还没来得及听见自己', emoji: '🌿', tagline: '', desc: '你不是单纯不会拒绝，而是常常在做出反应之后，才慢慢意识到自己原来并不想那样。边界感对你来说，第一步也许不是说"不"，而是先更清楚地知道"我想要什么"。' },
  },
}
...
export const roleTest = {
  ...
  results: {
    '倾听者': { label: '你是关系里的倾听者', emoji: '👂', tagline: '', desc: '你很擅长接住别人的情绪，很多人会因为你的安静和稳定而靠近你。只是有时候，你太习惯把位置让给别人，自己的委屈和需要反而被轻轻放在了后面。' },
    '照顾者': { label: '你是关系里的照顾者', emoji: '🤲', tagline: '', desc: '你总能很快看见别人缺什么，也很自然地把温柔落到细节里。只是照顾久了，也别忘了你不是只能负责气氛的人，你也值得被认真照顾。' },
    '表达者': { label: '你是关系里的表达者', emoji: '💬', tagline: '', desc: '你愿意把感受放到台面上，这种坦率其实很珍贵，也让关系少一些猜测。有时你会在说完之后反复回看，但真正重要的，往往不是你说得够不够完美，而是你没有把自己藏起来。' },
  },
}
...
export const discTest = {
  ...
  results: {
    D: { label: 'D 型 · 主导者', emoji: '🔥', tagline: '你的第一反应是推动它发生。不是等，不是看，是直接去做。有时候这让你走在所有人前面，有时候让你一个人走。', desc: '你的第一反应是行动。问题来了，你不会在原地分析太久，你会先找到一个方向，然后动起来。大多数人还在讨论的时候，你已经开始做了。 你对结果有很强的执着。你愿意承担压力，也愿意做决定——哪怕那个决定不是所有人都同意的。在你看来，没有决定是最差的选项。 你的直接有时候会让人不适应，但那是因为你的时钟比别人快。你不是不在乎他们，是你已经到下一步了。' },
    I: { label: 'I 型 · 影响者', emoji: '✨', tagline: '你走进一个房间，气氛就不一样了。你不是刻意的，你就是这样——你的能量会渗进周围。', desc: '你的能量是会传染的。你兴奋的时候，身边的人也会跟着兴奋；你投入地说一件事，别人会忍不住想听完。你的存在本身就是一种影响。 你在乎关系，在乎人。一个项目结束了，你记得的不是最终的数字，而是过程中那些真实的瞬间——谁说了什么，气氛在哪一刻变了，谁被看见了。 你的乐观是真实的，不是表演。你真的相信事情会好的，而且你的相信有时候会成为让事情真的好起来的原因。' },
    S: { label: 'S 型 · 稳健者', emoji: '🌿', tagline: '你是那个让人安心待在旁边的人。不是因为你什么都说好，而是你真的在，而且你不会突然消失。', desc: '你不制造混乱，你消化混乱。当周围的人都在乱的时候，你会自然地成为那个稳住的人——不是因为你没感觉，而是你处理感觉的方式很安静。 你重视关系里的稳定。你不会随意撕破一段关系，你会花时间维护它、修补它。有人在你旁边待着会觉得放心，因为你不会突然变卦，不会无缘无故消失。 你对变化需要更长的适应时间。这不是缺点，是你处理新事物的方式——你需要感觉到脚是踩在地上的，才能往前走。' },
    C: { label: 'C 型 · 谨慎者', emoji: '📐', tagline: '你在意每一个细节是否到位。别人觉得够了，你还没完。这种在意是你的标准，也是你最累的地方。', desc: '你的眼睛会自动扫描错误。别人看到的是整体，你看到的是某一处不对劲的地方。你不是故意挑剔，是你的感知系统就是这样设置的。 你做事之前需要想清楚。随意开始对你来说会造成焦虑，因为你知道细节里藏着风险。一旦想清楚了，你做的东西质量通常都很高。 你很难接受“差不多就好了”。不是完美主义，是你内心有一套清晰的标准，低于那条线你会难受。' },
  },
}
...
export const ecrTest = {
  id: 'ecr-36', axis: 'emotion', type: 'ecr', hasIntro: true,
  ...
  computeScores(answers) {
    ...
    return { avoidance: calc(avoidanceItems), anxiety: calc(anxietyItems) }
  },
  score(answers) {
    const { avoidance: av, anxiety: ax } = this.computeScores(answers)
    const scores = {
...
export const hspTest = {
  id: 'hsp-22', axis: 'emotion', type: 'slider',
...
export const erqTest = {
  id: 'erq-10', axis: 'emotion', type: 'slider',
